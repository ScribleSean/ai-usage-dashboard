...
const cases = [
  ...
  ['private pairing', '/private-sync/pairing.json', 'GET', {}, 404],
  ['pending pairing setup', '/private-sync/setup.pending.json', 'GET', {}, 404],
  ['private copied asset', '/assets/private-sync/setup.pending.json', 'GET', {}, 404],
