...
- This is a standalone public-source application repository. Personal context repositories store only pointers and private operating policy, not application source or required public dependencies.
...
- Preserve the three-view distinction and source provenance; unknown is not zero. No cross-host token or active-time sum until deduplication is verified.
